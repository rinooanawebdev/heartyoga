    ...
    <main>
        ...
        <?php        
            ...
            $sql = "SELECT * FROM yogaclass";
             ...
             // yogaclass table dividing depend on the day
            echo '<tr><th>Time</th><th>book</th><th>Type</th><th>Teacher</th><th>Room</th><th>Detail</th></tr>';
            
            $sql=$db->prepare('SELECT * FROM yogaclass');
           ...
           foreach($db->query('SELECT * FROM yogaclass WHERE classdate = "2023-04-01" ORDER BY classtime ASC') as $class){
            ...
            echo '<td><a href="class-detail.php?classId=', $class['classId']. '">Book Class</a></td>';
           ...
           echo '<tr><th><b>Sun<b> <small>April 3, 2023</small></td></tr>';
